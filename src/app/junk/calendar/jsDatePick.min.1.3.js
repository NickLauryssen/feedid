g_l = [];
g_l.MONTHS = [ "Januari", "Februari", "Maart", "April", "Mei", "Juni", "Juli",
		"Augustus", "September", "Oktober", "November", "December" ];
g_l.DAYS_3 = [ "Zo", "Ma", "Di", "Wo", "Do", "Vr", "Za" ];
g_l.MONTH_FWD = "Volgende maand";
g_l.MONTH_BCK = "Vorige maand";
g_l.YEAR_FWD = "Volgend jaar";
g_l.YEAR_BCK = "Vorig jaar";
g_l.CLOSE = "Sluit kalender";
g_l.ERROR_2 = g_l.ERROR_1 = "Ongeldig datumobject!";
g_l.ERROR_4 = g_l.ERROR_3 = "Ongeldig doel";
